...
public class prinGerente extends javax.swing.JFrame {
    ...
    private boolean validarCampos(String nombreUsu, String nombre, String cedula, String correo, String cuenta, String direccion, String telefono, String salario, String fechaNac) {
        ...
        if(cedula.length() < 8){mensaje = mensaje+"- Tamaño Cedula\n"; validacion = false; }
        ...
        if(!validacion){ //Hay campos vacios
            mensaje = "Los siguientes campos están vacios o incorrectos:\n"+mensaje;
    ...
    private void consultar(int index){
     ...
     private void consultarInfoPersonal(){
        ...
        String mensaje = "Nombre: "+ger.getNombre()+"\n"+
                         ...
                         "Sede: "+sede.getNombreSede()+"\n"+
                         "Fecha Ingreso: "+ger.getFechaRegistro()+"\n"+
    ...
    private void initComponents() {
        ...
        Profile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/ICO boss.png"))); // NOI18N
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(comboxSedes, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
