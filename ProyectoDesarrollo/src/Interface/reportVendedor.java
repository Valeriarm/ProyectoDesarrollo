 ...
 * @author Marthox
 */
public class reportVendedor extends javax.swing.JFrame {

    private DBConnection bD;
    private final String idVendedor;
    
    public reportVendedor(DBConnection baseDatos, String idVendedor) {
        initComponents();
        llenarCBox();
        this.bD = baseDatos;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Inventario", "Ventas" }));
        ...
        jLabel1.setText("Reportes Jefe de Taller");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ("Inventario".equals(String.valueOf(this.jComboBox1.getSelectedItem()))){
            ...
            if(null != String.valueOf(this.jComboBox2.getSelectedItem()))switch (String.valueOf(this.jComboBox2.getSelectedItem())) {
                case "Dia":
                valores = bD.reporteVentasDia(idVendedor, initDate, finishDate);
                break;
                case "Mes":
                valores = bD.reporteVentasMes(idVendedor, initDate, finishDate);
                break;
                case "Anio":
                valores = bD.reporteVentasAnio(idVendedor, initDate, finishDate);
                break;
                default:
                break;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reportVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new reportVendedor().setVisible(true);
            }
        });
    }
